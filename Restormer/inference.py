...
def main():
    ...
    parser.add_argument('--result_dir', default='/data1/uni/data/mayo2d/test/out/Restormer_test', type=str)
    parser.add_argument('--weights', default='experiments/models/net_g_200000.pth', type=str)
