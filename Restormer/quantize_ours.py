...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='./experiments/models/net_g_latest.pth')
    parser.add_argument('--train_gt', type=str, default='/data2/uni/data/mayo2d/train/full_1mm')
    parser.add_argument('--train_lq', type=str, default='/data2/uni/data/mayo2d/train/quarter_1mm')
    parser.add_argument('--save_dir', type=str, default='./experiments/quantized_models_ours')
