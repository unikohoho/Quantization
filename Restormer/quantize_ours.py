...
def quantize_model(original_model, bit, calibration_dataloader, device, save_path):
    ...
    # -------------------------------------------------------------------
    # Keep the first (patch_embed.proj) and last (output) layers at 8-bit
    # even when the target body bit-width is 2/4. This follows the common
    # PTQ convention adopted by our compared baselines (BRECQ, PTQ4SR,
