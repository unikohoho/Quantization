...
class OptimizationWrapper:
    ...
    def optimize(self):
        ...
        # -------------------------------------------------------
        print("\n[Step 3] Starting Fine-tuning (Pure Wavelet Loss - Small Batch)...")
        ...
        for phase_name, steps in self.schedule:
            ...
            while iter_count < steps:
                ...
                # l_total = 0.3 * l_ll + 0.5 * l_hh + 0.2 * l_high
...
def main():
    ...
    # Dataset
    print("Initializing Calibration Dataset (Custom 120 samples)...")
