...
def main():
    ...
    # -------------------------------------------------------------------
    # First/last layers are kept at 8-bit (same convention as the
    # PTQ baselines we compare against). Must match quantize_ours.py
    # so that the saved n_bit Parameters reload correctly.
    # -------------------------------------------------------------------
